...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
        ...
        String detail = "O corpo da requisição está inválido. Verifique novamente";
    ...
    private ResponseEntity<Object> handleInvalidFormatException(InvalidFormatException ex, HttpHeaders headers, HttpStatus status, WebRequest request){
        ...
        ProblemType problemType = ProblemType.MENSAGEM_INCOMPREENSIVEL;
        String detail = String.format("A propriedade '%s' não pode receber um valor do tipo '%s'. informe um valor do tipo '%s'",
    ...
    public ResponseEntity<?> handleEntidadeNaoEncontradaException(EntidadeNaoEncontradaException ex, WebRequest request){
        ...
        //esse é um jeito que vc usa o metodo da classe reponseEntityException para tratar varias exceptions, porém aqui vc está customizando para quando tiver not found
...
//                .body(problema);
    ...
    private ResponseEntity<Object> handleMethodArgumentTypeMismatch(MethodArgumentTypeMismatchException ex, HttpHeaders headers,
        ...
        String detail = String.format("O parametro de URL '%s' recebeu o valor '%s' que é um tipo inválido. Corrija e informe um valor compatível com o tipo '%s'",
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers,
        ...
        String detail = "Um ou mais parametros estão inválidos. Preencha corretamente e envie novamente";
